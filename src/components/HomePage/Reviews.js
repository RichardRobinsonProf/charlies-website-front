          ...
          text= {
            <figure>
							<blockquote className="blockquote">
								<p><i className="text-secondary" aria-hidden="true"></i>"El Instituto Robinson ofrece cursos adaptables para estudiantes de todos los niveles, ajustándose a las necesidades particulares de cada uno, ya sea que se necesite por razones laborales, académicas, etc. . Además, es muy recomendable para estudiantes avanzados de Inglés, profesores, traductores, intérpretes etc., ya que el estudiar con profesores nativos permite lograr una práctica periódica de conversación, escucha e interacción en Inglés REAL con alto grado de exigencia. En mi caso, por ejemplo, me ayudó a evitar pensar en Español, vicio generalmente arraigado en los hispanoparlantes." <i className="fas fa-fw fa-quote-right text-secondary" aria-hidden="true"></i></p>
							</blockquote>
							<figcaption className="blockquote-footer">Andrea - Profesora de inglés y traductora <time dateTime="2020-09-01T12:00">(September 01 2020 12:00)</time></figcaption>
						</figure>
          }/>
          </div>
          }
